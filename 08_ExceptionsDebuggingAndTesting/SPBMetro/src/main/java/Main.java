...
public class Main
{
    ...
    private static final Marker EXCEPTION_STATIONS_MARKER = MarkerManager.getMarker("EXCEPTION");
    ...
    public static void main(String[] args)
    {
        ...
        } catch(StationNameException exception){
            LOGGER.info(EXCEPTION_STATIONS_MARKER, "Произошла ошибка: ", exception);
